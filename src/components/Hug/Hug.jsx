    ...
    return(
        <div className="maximum-width">
            ...
            <div onClick={() => toggle("fiabilite")} className="dropdown">
                ...
                <div className={selected === "fiabilite" ? "content show" : "content"}><p>Les annonces postées sur Kasa garantissent une fiabilité totale. Les Photos sont conformes aux logements, et toutes les informations sont régulièrement vérifiées par nos équipes</p></div>
            </div>
